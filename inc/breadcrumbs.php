...
function get_breadcrumbs() {
	...
	$text['home']     = __('Home','bebe');
	$text['category'] = __('Archive','bebe').' "%s"';
	$text['search']   = __('Search results','bebe').' "%s"';
	$text['tag']      = __('Tag','bebe').' "%s"';
	$text['author']   = __('Author','bebe').' %s';
	$text['404']      = __('Error 404','bebe');

	$show_current   = 1;
	$show_on_home   = 0;
	$show_home_link = 1;
	$show_title     = 1;
	$delimiter      = '&nbsp; <span class="arrow">→</span> &nbsp;';//это разделитель в меню бредкрампс
